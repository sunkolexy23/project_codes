                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="flex-grow-1">
                            <a href="{{ route('lab-add') }}" class="btn btn-info add-btn" ><i class="ri-add-fill me-1 align-bottom"></i> Add Lab</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                            <a href="{{url('/admin/lab/view')}}/{{$lab->id}}" class="view-item-btn"><i class="ri-eye-fill align-bottom text-muted"></i> View</a>
                                        </li>
                                    </td>
                                </tr>
