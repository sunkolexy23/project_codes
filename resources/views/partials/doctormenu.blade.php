            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('doctor-dashboard')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('doctor-patient')}}">
                                <i class="ri-layout-3-line"></i> <span data-key="t-dashboard">Patients</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('doctor-prescription')}}">
                                <i class="ri-layout-3-line"></i> <span data-key="t-dashboard">Prescription</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('doctor-appointment')}}">
